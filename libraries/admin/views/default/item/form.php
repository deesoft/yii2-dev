        ...
        <div class="box-body">
            <div class="form-group" ng-class="{'has-error':modelError.name}">
                ...
                <div class="col-sm-9">
                    ...
                    <div ng-if="modelError.name" class="help-block" ng-bind="modelError.name"></div>
                </div>
            </div>
            <div class="form-group" ng-class="{'has-error':modelError.description}">
                ...
                <div class="col-sm-9">
                    ...
                    <div ng-if="modelError.description" class="help-block" ng-bind="modelError.description"></div>
                </div>
            </div>
            <div class="form-group" ng-class="{'has-error':modelError.ruleName}">
                ...
                <div class="col-sm-9">
                    ...
                    <div ng-if="modelError.ruleName" class="help-block" ng-bind="modelError.ruleName"></div>
                </div>
            </div>
            <div class="form-group" ng-class="{'has-error':modelError.data}">
                ...
                <div class="col-sm-9">
                    ...
                    <div ng-if="modelError.data" class="help-block" ng-bind="modelError.data"></div>
                </div>
            </div>
