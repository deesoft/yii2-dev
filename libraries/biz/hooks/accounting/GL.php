...
namespace biz\core\hooks\accounting;

use Yii;
use biz\core\base\Event;
use biz\core\components\accounting\GL as ApiGL;
...
class GL extends \yii\base\Behavior
{
    ...
    {
        /* @var $model \biz\core\models\accounting\Invoice */
    ...
    {
        /* @var $model \biz\core\models\accounting\Payment */
        $model = $event->params[0];
        $value = 0;
