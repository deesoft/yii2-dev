...
namespace biz\core\components\inventory;

use biz\core\models\inventory\StockAdjustment as MStockAdjustment;
use biz\core\models\inventory\StockOpname;
use biz\core\models\master\ProductStock;
use biz\core\models\master\ProductUom;
...
class StockAdjustment extends \biz\core\base\Api
{
     ...
     * @var string 
     */
    public $modelClass = 'biz\core\models\inventory\StockAdjustment';
     ...
     *
     * @param  array                                  $data
     * @param  \biz\core\models\inventory\StockAdjustment $model
     * @return \biz\core\models\inventory\StockAdjustment
     */
