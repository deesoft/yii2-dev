...
namespace biz\core\components\purchase;

use Yii;
use biz\core\models\purchase\Purchase as MPurchase;
...
class Purchase extends \biz\core\base\Api
{
     ...
     * @inheritdoc
     */
    public $modelClass = 'biz\core\models\purchase\Purchase';
     ...
     *
     * @param \biz\core\models\purchase\Purchase $model
     *
     * @return \biz\core\models\purchase\Purchase
     * @throws \Exception
     */
