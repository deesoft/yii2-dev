...
use biz\api\models\master\PriceCategory as PriceCategoryModel;

/**
 * PriceCategory represents the model behind the search form about `biz\api\models\master\PriceCategory`.
 */
