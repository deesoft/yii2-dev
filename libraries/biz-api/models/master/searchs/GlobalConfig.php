...
use biz\api\models\master\GlobalConfig as GlobalConfigModel;

/**
 * GlobalConfig represents the model behind the search form about `biz\api\models\master\GlobalConfig`.
 */
