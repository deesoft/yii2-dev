...
namespace biz\api\models\sales\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use biz\api\models\sales\Sales as SalesModel;

/**
 * Sales represents the model behind the search form about `biz\api\models\sales\Sales`.
 */
