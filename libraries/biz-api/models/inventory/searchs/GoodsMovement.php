...
use biz\api\models\inventory\GoodsMovement as GoodsMovementModel;

/**
 * GoodsMovement represents the model behind the search form about `biz\api\models\inventory\GoodsMovement`.
 */
