                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group required" ng-class="{error:errors.branch_id}">
                            ...
                            <span ng-if="useReff" class="form-control" ng-bind="model.branch.name"></span>
                        ...
                        <div class="form-group required" ng-class="{error:errors.warehouse_id}">
                            ...
                            <select id="movement-warehouse_id" name="warehouse_id" class="form-control" ng-model="model.warehouse_id"
                                   ng-options="warehouse as warehouse.name for warehouse in warehouses.get(model.branch_id)">
                            </select>
