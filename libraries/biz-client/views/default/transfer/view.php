...
<div class="transfer-view">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <div class="btn-group">
                <a ng-href="#/transfer/" class="btn btn-success btn-sm">Index</a>
            </div>
            <div class="btn-group" ng-if="model.status == 10">
                <a ng-href="#/transfer/{{paramId}}/edit" class="btn btn-primary btn-sm">Update</a>
            ...
            <div class="btn-group">
                ...
                <a class="btn btn-success btn-sm"
                   ng-href="#/movement/new/300/{{paramId}}"
                   ng-if="model.status == 20">Create GI</a>
                <a class="btn btn-success btn-sm"
                   ng-href="#/movement/new/400/{{paramId}}"
        ...
        <div class="box-body">
            <table class="table table-striped table-bordered detail-view">
                ...
                <tr><th>Branch Dest</th><td>{{model.branchDest.name}}</td></tr>
        ...
        <div class="box-footer">
            <tabset>
                ...
                <tab heading="Issue" ng-if="model.status > 10">
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="tabular table-striped col-lg-12">
                                <thead style="background-color: #9d9d9d;">
