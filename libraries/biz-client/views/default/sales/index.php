...
-->
                    <td>
                        <a ng-href="#/sales/view/{{model.id}}"><span class="glyphicon glyphicon-eye-open"></span></a>
                        <a ng-href="#/sales/update/{{model.id}}" ng-if="model.status==10"><span class="glyphicon glyphicon-pencil"></span></a>
