            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="form-group required" ng-class="{error:errors.customer_id}">
                        ...
                        <input id="sales-customer_id" name="supplier_id" class="form-control" ng-model="model.customer"
                               typeahead="customer as customer.name for customer in customer.asArray() | filter:$viewValue | limitTo:8">
