...
<div class="sales-view">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <div class="btn-group">
                <a ng-href="#/sales/" class="btn btn-success btn-sm">Index</a>
            </div>
            <div class="btn-group" ng-if="model.status == 10">
                <a ng-href="#/sales/{{paramId}}/edit" class="btn btn-primary btn-sm">Update</a>
            ...
            <div class="btn-group">
                ...
                <a class="btn btn-success btn-sm"
                   ng-href="#/movement/new/200/{{paramId}}"
                   ng-if="model.status == 20">Create Issue</a>
            </div>
        </div>
        <div class="box-body">
            <table class="table table-striped table-bordered detail-view">
                ...
                <tr><th>Customer</th><td>{{model.customer.name}}</td></tr>
        ...
        <div class="box-footer">
            <tabset>
                            ...
                            <table class="tabular table-striped col-lg-12">
                                <thead style="background-color: #9d9d9d;">
                                    <tr>
                                        ...
                                        <th class="col-lg-1" style="text-align: right;">Issued</th>
                                ...
                                <tbody id="item-grid">
                                    <tr ng-repeat="(idx,item) in model.items" data-key="{{idx}}">
                                        ...
                                        <td  style="text-align: right;">{{item.total_release}}</td>
                                        <td >{{item.uom.name}}</td>
                ...
                <tab heading="Issued" ng-if="model.status > 10">
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="tabular table-striped col-lg-12">
                                <thead style="background-color: #9d9d9d;">
                                ...
                                <tbody id="item-grid">
                                    <tr ng-repeat="(idx,item) in issues" data-key="{{idx}}">
                                        <td >{{item.number}}</td>
                                        ...
                                        <td >
                                            ...
                                            <a href ng-click="applyGI(item)" title="Apply" ng-if="item.status == 10"><span class="glyphicon glyphicon-ok-sign"></span></a>
                                            <a href ng-click="rejectGI(item)" title="Reject" ng-if="item.status == 20"><span class="glyphicon glyphicon-minus-sign"></span></a>
                                            <a href ng-click="deleteGI(item)" title="Delete" ng-if="item.status == 10"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
